...
Dim pTabelaNome As String: pTabelaNome = "tblCompraNF"
Dim pTabelaCampos As String: pTabelaCampos = "SELECT DISTINCT campo FROM tblOrigemDestino WHERE tabela = '" & pTabelaNome & "';" '' ORDER BY id
...
Dim script As String
    ...
    '' CRIAR TABELA
    qryProcessos = Array("DROP TABLE " & pTabelaNome, script, "DELETE FROM " & pTabelaNome)
