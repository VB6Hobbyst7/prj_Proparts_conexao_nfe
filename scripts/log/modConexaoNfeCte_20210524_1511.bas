...
Dim sql As String: sql = "UPDATE tblCompraNFItem SET tblCompraNFItem.ID_CompraNF_CompraNFItem = DLookUp(""CodigoProd_Grade"",""dbo_tabGradeProdutos"",""CodigoForn_Grade='"" & [tblCompraNFItem].[ID_Prod_CompraNFItem] & ""'"");"
    ...
    s.processamentoDeCompras "C:\temp\Coleta\68.365.5010003-77 - Proparts Comércio de Artigos Esportivos e Tecnologia Ltda\42210212680452000302550020000886301507884230-nfeproc.xml"
       
       
    '' TRANSF. DE MERCADORIAS
    s.processamentoDeCompras "C:\temp\Coleta\68.365.5010003-77 - Proparts Comércio de Artigos Esportivos e Tecnologia Ltda\32210368365501000296550000000638811001361356-nfeproc.xml"
...
'    s.processamentoDeCompras "C:\temp\Coleta\68.365.5010002-96 - Proparts Comércio de Artigos Esportivos e Tecnologia Ltda\32210248740351015359570000000309211914301218-cteproc.xml"
'
'    '' PREST. SERV. TRANSPORTE A ESTABELECIMENTO COMERCIAL
'    s.processamentoDeCompras "C:\temp\Coleta\68.365.5010003-77 - Proparts Comércio de Artigos Esportivos e Tecnologia Ltda\42210220147617000494570010009539201999046070-cteproc.xml"
