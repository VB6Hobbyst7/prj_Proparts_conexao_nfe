...
Sub TESTE_CARREGAR()
    ...
    '' RELACAO DE CAMPO ChvAcesso_CompraNF
'    Application.CurrentDb.Execute qryUpdateProcessamento_RelacaoCamposDeTabelas_ChvAcesso_CompraNF
