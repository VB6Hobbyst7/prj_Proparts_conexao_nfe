...
Dim totalDeRegistros As Long: totalDeRegistros = arquivos.count
    ...
    For Each Item In arquivos
        ...
        Debug.Print "carregarDadosGerais " * contadorDeRegistros & " - " & totalDeRegistros
...
Dim sqlArquivosValidos As String: sqlArquivos = _
...
Dim qryUpdateProcessado As String: qryUpdate = _
...
'' Listagem de arquivos
Dim sqlArquivosInvalidosNaoProcessado As String: sqlArquivos = _
    "SELECT ChvAcesso, CaminhoDoArquivo FROM  tblDadosConexaoNFeCTe WHERE (((tblDadosConexaoNFeCTe.registroValido)=0) AND ((tblDadosConexaoNFeCTe.registroProcessado)=0));"
Debug.Print sqlArquivosInvalidosNaoProcessado


'' Atualização de expurgo
Dim qryUpdateExpurgo As String: qryUpdate = _
        "UPDATE tblDadosConexaoNFeCTe SET tblDadosConexaoNFeCTe.registroProcessado = 4 WHERE tblDadosConexaoNFeCTe.ChvAcesso =""strChave"";"
Debug.Print qryUpdate
