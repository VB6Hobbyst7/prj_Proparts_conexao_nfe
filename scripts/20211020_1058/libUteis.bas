...
Dim Comando As Variant
    ...
    For Each Comando In comandos
        Debug.Print Comando
        If DLookup("[ValorDoParametro]", "[tblParametros]", "[TipoDeParametro]='debug'") Then TextFile_Append CurrentProject.path & "\" & strLog(), CStr(Comando)
...
Dim strDestino As String
    ...
    Do While Not rstArquivos.EOF
        ...
        If DLookup("[ValorDoParametro]", "[tblParametros]", "[TipoDeParametro]='debug'") Then TextFile_Append CurrentProject.path & "\" & strLog(), strOrigem
        
        strDestino = rstArquivos.Fields("strDestino").value
        Debug.Print strDestino
        If DLookup("[ValorDoParametro]", "[tblParametros]", "[TipoDeParametro]='debug'") Then TextFile_Append CurrentProject.path & "\" & strLog(), strDestino
        ...
        Debug.Print qryTemp
        If DLookup("[ValorDoParametro]", "[tblParametros]", "[TipoDeParametro]='debug'") Then TextFile_Append CurrentProject.path & "\" & strLog(), qryTemp
