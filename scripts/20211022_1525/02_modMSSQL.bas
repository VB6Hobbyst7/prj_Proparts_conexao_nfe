...
Dim tmpScript As String
    ...
    Set rstOrigem = db.OpenRecordset("Select * from (" & Scripts.SelectRegistroValidoPorcessado & ") as tmpRepositorio where tmpRepositorio.ChvAcesso_CompraNF = '" & pChvAcesso & "'")
