...
totalDeRegistros = arquivos.count
    ...
    For Each Item In arquivos
        ...
        TextFile_Append CurrentProject.path & "\" & strLog(), "carregarDadosGerais " & contadorDeRegistros & " - " & CStr(totalDeRegistros)
...
adm_Err:
    ...
    TextFile_Append CurrentProject.path & "\" & strLog(), "processarArquivosPendentes() - " & Err.Description
    Resume adm_Exit
...
Dim DT_PROCESSO As Date: DT_PROCESSO = Now()
    ...
    TextFile_Append CurrentProject.path & "\" & strLog(), "Concluido! - enviarDadosServidor"
...
Dim qrySelectRegistroValido As String: qrySelectRegistroValido = _
    ...
    TextFile_Append CurrentProject.path & "\" & strLog(), qrySelectRegistroValido
...
'    s.criarArquivoJson opManifesto, qrySelectRegistroValido, strCaminhoDeSaida
    ...
    TextFile_Append CurrentProject.path & "\" & strLog(), "Concluido! - criacaoArquivosJson"
