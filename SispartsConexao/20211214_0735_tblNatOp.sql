...
FROM (
	VALUES (
		...
		,'PSP'
		,'1.949'
		,'Entrada de Produtod p/ Mostruário'
		,''
		,''
		,''
		)
		...
		,'PSP'
		,'5.918'
		,'Devolução de Recebimento em Consignação'
		,''
		,''
		,''
		)
		...
		,'PSP'
		,'5.913'
		,'Retorno de Recebimento p/ Demonstração'
		,'41'
		,'99'
		,'08'
		)
		...
		,'PSP'
		,'1.949'
		,'Retorno de Remessa p/ Mostruário'
		,''
		,''
		,''
		)
		...
		,'PSP'
		,'1.913'
		,'Retorno de remessa p/ demonstração'
		,'50'
		,'00'
		,'08'
		)
		...
		,'PSP'
		,'5.949'
		,'- Inativo -Remessa para empréstimo'
		,'00'
		,'50'
		,'08'
		)
		...
		,'PSP'
		,'3.949'
		,'Inativo Importação p/ Garantia - Pagamento Invoice'
		,'00'
		,'00'
		,'01'
		)
		...
		,'PSP'
		,'1.906'
		,'Ret Mercadoria Rem p/ Depósito Fech ou Armz Geral'
		,'41'
		,'03'
		,'07'
		)
		...
		,'PSP'
		,'1.000'
		,'Entrada ou Aquisição de Serviço'
		,'41'
		,'03'
		,'07'
		)
		...
		,'PSP'
		,'2.152'
		,'Entrada Transferência p/ Comercialização'
		,'00'
		,'00'
		,'07'
		)
		...
		,'PSP'
		,'2.914'
		,'Retorno de Remessa p/ Exposição/Feira'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'5.413'
		,'Devolução de Compra p/ Uso ou Consumo c/ ST'
		,'60'
		,'53'
		,'08'
		)
		...
		,'PSP'
		,'2.912'
		,' Entrada recebida p/ demonstração'
		,'00'
		,'00'
		,'08'
		)
		...
		,'PSP'
		,'5.405'
		,'Venda Adquirida de Terceiros c/ ST - (Substituído)'
		,'60'
		,'53'
		,'01'
		)
		...
		,'PSP'
		,'5.949'
		,'Regularização Mudança de Endereço'
		,'41'
		,'53'
		,'08'
		)
		...
		,'PSP'
		,'1.557'
		,'Devolução de Transf. de Material p/ Uso ou Consumo'
		,'00'
		,'00'
		,'08'
		)
		...
		,'PSP'
		,'2.152'
		,'Complemento de Valores - Transferência'
		,'00'
		,'00'
		,'08'
		)
		...
		,'PSP'
		,'6.206'
		,'Anulação de Valores Relativo a Serv. de Transporte'
		,'90'
		,'99'
		,'08'
		)
		...
		,'PSP'
		,'1.949'
		,'Devolução de Troca em Garantia'
		,'00'
		,'00'
		,'08'
		)
		...
		,'PSP'
		,'1.652'
		,'Compra de Combustível/ Lubrificante p/ Comercializ'
		,'60'
		,'03'
		,'70'
		)
		...
		,'PSP'
		,'1.653'
		,'Compra de Combustível/ Lubrificante p/ Uso ou Cons'
		,'40'
		,'49'
		,'07'
		)
		...
		,'PSP'
		,'6.110'
		,'*** Não Usar - Venda Adq Terc SUFRAMA'
		,'00'
		,'55'
		,'06'
		)
		...
		,'PSP'
		,'1.253'
		,'Entrada de Energia Elétrica p/ Estab. Com.'
		,'41'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'1.923'
		,'Entrada Receb do Vend Remetente em Venda à Ordem'
		,'90'
		,'49'
		,'70'
		)
		...
		,'PSP'
		,'5.553'
		,'Devolução de Compra ou Bem p/ Ativo Imobilizado'
		,''
		,''
		,''
		)
		...
		,'PSP'
		,'2.102'
		,'Compra p/ Revenda (IPI Não Tributado)'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'1.403'
		,'Compra p/ Revenda c/ ST (IPI Não Tributado)'
		,'60'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'2.910'
		,'Entrada de Bonificação (IPI Não Tributado)'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'1.910'
		,'Entrada Bonificação (IPI não Tributado)'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PES'
		,'2.152'
		,'Entrada Transf. p/ Comercialização'
		,'00'
		,'00'
		,'07'
		)
		...
		,'PES'
		,'1.000'
		,'Entradas ou Aquisições de Serviço'
		,'41'
		,'03'
		,'07'
		)
		...
		,'PES'
		,'1.949'
		,'Entrada de Importação por Conta e Ordem'
		,'20'
		,'00'
		,'08'
		)
		...
		,'PES'
		,'1.949'
		,'Entrada de Importação por Conta e Ordem (ST)'
		,'70'
		,'00'
		,'08'
		)
		...
		,'PES'
		,'1.949'
		,'Entrada Importação Conta Ordem Extemporânea'
		,'20'
		,'00'
		,'08'
		)
		...
		,'PES'
		,'6.110'
		,'*** NÃO USAR - Venda Adq Terc.SUFRAM'
		,'00'
		,'52'
		,'06'
		)
		...
		,'PES'
		,'2.102'
		,'Compra para Revenda (IPI Não Tributado)'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PES'
		,'2.910'
		,'Entrada bonificação, doação ou brinde'
		,''
		,''
		,''
		)
		...
		,'PES'
		,'2.910'
		,'Entrada bonific, doação ou brinde (IPI não Tribut)'
		,'00'
		,'03'
		,''
		)
		...
		,'PES'
		,'2.102'
		,'Compra para Revenda (IPI Não Tributado) IPI BCICMS'
		,'00'
		,'03'
		,'08'
		)
		...
		,'PSP'
		,'1.926'
		,'Entrada Decorrente de Desagregação'
		,'40'
		,'49'
		,'99'
		)
		...
		,'PES'
		,'5.927'
		,'Baixa de estoque - Perda Importação'
		,'20'
		,'50'
		,'08'
		)
		...
		,'PSP'
		,'3.949'
		,'Importação p/ Produtos de Homologação'
		,'41'
		,'03'
		,'70'
		)
		...
		,'PSC'
		,'3.949'
		,'Importação p/ Garantia - Pagamento Invoice'
		,'90'
		,'49'
		,'99'
		)
		...
		,'PSP'
		,'7.949'
		,'Outras Saídas de Mercadoria/Prestação de Serviço'
		,'90'
		,'53'
		,'49'
		)
		...
		,'PSC'
		,'5.206'
		,'Anulação de Valor Relativo à Serviço de Transporte'
		,'90'
		,'53'
		,'08'
		)
		...
		,'PSP'
		,'3.949'
		,'Importação p/ Garantia - Sem Pagamento Invoice'
		,'41'
		,'03'
		,'70'
		)
		...
		,'PSP'
		,'6.553'
		,'Devolução de compra de ativo imobilizado'
		,'41'
		,'53'
		,'08'
		)
		...
		,'PSP'
		,'5.914'
		,'Remessa p/ Exposição ou Feira - Estrutura'
		,'40'
		,'55'
		,'08'
		)
		...
		,'PSP'
		,'1.914'
		,'Retorno de Remessa p/ Exposição/Feira - Estrutura'
		,'40'
		,'05'
		,'08'
		)
		...
		,'PSC'
		,'6.152'
		,'Transf. de Mercadorias (P/ Análise)'
		,'00'
		,'50'
		,'08'
		)
