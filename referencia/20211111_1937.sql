...
SELECT 1
	,(select CodigoProd_Grade from tabGradeProdutos where CodigoForn_Grade='00.1918.117.006') as tmpID_Prod_CompraNFItem
	,'6152'
	,00
	,4527.48
	,181.10
	...
	,4527.48
	,4527.48
	,(Select ID_CompraNF from tblCompraNF where ChvAcesso_CompraNF='32210268365501000296550000000637741001351624') as tmpPK;