...
Function carregarCamposNomesProcessamento(pRepositorio As String) As String
Dim Scripts As New clsConexaoNfeCte
...
Dim tmpCampoValor As String
    ...
    Set rstCampos = db.OpenRecordset(Replace("Select * from qryProcessamento_Select_CompraComItens where NomeTabela='pRepositorio';", "pRepositorio", pRepositorio))
    Do While Not rstCampos.EOF
    ...
    tmpCampoNome = "INSERT INTO tblCompraNF (" & left(tmpCampoNome, Len(tmpCampoNome) - 1) & ") "
    ...
    carregarCamposNomesProcessamento = tmpCampoNome & tmpCampoValor
