...
-- qryUpdate_tblCompraNF_BaseCalcICMS_CompraNF
UPDATE tblCompraNF SET tblCompraNF.BaseCalcICMS_CompraNF = "0"
WHERE (((tblCompraNF.BaseCalcICMS_CompraNF) Is Null));
