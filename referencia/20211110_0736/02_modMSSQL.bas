...
Dim tmpScript As String
    ...
    Set rstCampos = db.OpenRecordset("qryProcessamento_Select_CompraComItens")
    Do While Not rstCampos.EOF
        tmpScript = tmpScript & rstCampos.Fields("NomeCampo").value & ","
        rstCampos.MoveNext
        DoEvents
    Loop
    ...
    carregarCamposNomesProcessamento = left(tmpScript, Len(tmpScript) - 1)
