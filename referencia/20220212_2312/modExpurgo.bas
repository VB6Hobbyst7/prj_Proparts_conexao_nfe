Attribute VB_Name = "modExpurgo"
Option Compare Database

Sub cadastro_caminhoDeColetaTentativaDeReprocessamento()

    Dim strPathSource As String: strPathSource = "C:\ConexaoNFe\XML\TentativaDeReprocessamento\"
    
    Dim sql_Insert_Reprocessamento As String: sql_Insert_Reprocessamento = _
    "INSERT INTO tblParametros ( TipoDeParametro, ValorDoParametro, Objetivo ) SELECT 'caminhoDeColetaTentativaDeReprocessamento' AS strParam, '" & strPathSource & "' AS strValor, 'ADM | Caminhos - Arquivos em tentativas de reprocessamento' AS strObj;"
    
    Application.CurrentDb.Execute sql_Insert_Reprocessamento
