...
TextFile_Append CurrentProject.path & "\" & strLog(), sqlCampos
...
'    Debug.Print tmpScript
    ...
    TextFile_Append CurrentProject.path & "\" & strLog(), tmpSelecaoDeRegistros
...
'                Debug.Print "#### " & rstCampos.Fields("campo").value
        ...
        TextFile_Append CurrentProject.path & "\" & strLog(), tmpScript & tmp
        ...
        If (pDestino = "tblCompraNFItem") Then
            ...
            Debug.Print tmp
            TextFile_Append CurrentProject.path & "\" & strLog(), tmp
